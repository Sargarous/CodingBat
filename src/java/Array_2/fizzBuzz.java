...
// and end=5 gives the series 1, 2, 3, 4. Return a new String[] array containing the string form of
// these numbers, except for multiples of 3, use "Fizz" instead of the number, for multiples of 5 use
...
// since you have to allocate and index into an array instead of just printing, and we vary the start/end
